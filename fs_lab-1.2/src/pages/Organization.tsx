...
// Full leadership & management data
const leadershipData: Role[] = [
  ...
  { firstName: "", lastName: "", role: "Left Vacant for future expansion" },
  { firstName: "", lastName: "", role: "Left Vacant for future expansion" },
  { firstName: "", lastName: "", role: "Left Vacant for future expansion" },
  { firstName: "", lastName: "", role: "Left Vacant for future expansion" },
  { firstName: "", lastName: "", role: "Left Vacant for future expansion" },
    ...
    <div className="organization-page">
      ...
      <ul>
        {leadershipData.map((person, index) => (
          <li key={index} style={{ display: "flex", justifyContent: "space-between", padding: "5px 0", borderBottom: "1px solid #ccc" }}>
